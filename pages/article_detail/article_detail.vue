<template>
	<view class="container">
		...
		<view class="leftright2">
			<view class="left2">
				<button class="btn-floating orange-gradient" v-show="go1" @tap="getVerifyCode">
					喜欢
				</button>
				<button class="btn-floating orange-gradient" v-show="go2" >
					<uni-countdown :show-day="false" :second="60" @timeup="timeup"></uni-countdown>
					已喜欢
				</button>
			</view>
			<view class="right2">
				<button class="btn-floating orange-gradient" @tap="shan">删除</button>
			</view>
		</view>
		<div class="tuijian">
			<text class="info-text">相关推荐</text>
			<div class="card2">
				<text style="font-size: 32upx;">草木一秋</text>
				<text style="font-size: 30upx;margin-top: 10px;">阅读量</text>
			</div>
			<div class="card2">
				<text style="font-size: 32upx;">我就是我</text>
				<text style="font-size: 30upx;margin-top: 10px;">阅读量</text>
			</div>
		</div>
		<div class="leftright3">
			<div class="left2">
